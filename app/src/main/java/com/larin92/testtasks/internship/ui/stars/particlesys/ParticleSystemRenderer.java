package com.larin92.testtasks.internship.ui.stars.particlesys;
...
public class ParticleSystemRenderer implements GLSurfaceView.Renderer {
    ...
    private com.larin92.testtasks.internship.ui.stars.particlesys.ParticleSystem mParticleSystem;
    ...
    public void onSurfaceChanged(GL10 unused, int width, int height) {
        ...
        mExecutor.execute(new com.larin92.testtasks.internship.ui.stars.particlesys.ParticlesGenerator(this));
    }
    ...
    public void logFrame() {
        ...
        if (timePassed >= 10_000) {
            Timber.d("fps %d @ %d stars || %f", frames / 10, com.larin92.testtasks.internship.ui.stars.particlesys.ParticleSystem.PARTICLE_COUNT, mTime);
            frames = 0;
    ...
    public com.larin92.testtasks.internship.ui.stars.particlesys.ParticleSystem getParticleSystem() {
        return mParticleSystem;
    }

    public void setParticleSystem(final com.larin92.testtasks.internship.ui.stars.particlesys.ParticleSystem particleSystem) {
